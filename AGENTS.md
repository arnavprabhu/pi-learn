...
- Inspect frontier: `/frontier`
- State files: `learner/concepts.json`, `learner/evidence.jsonl`, `MISSION.md`, `learning-records/`
- Source context: `knowledge/`; indexed locally when teaching starts
